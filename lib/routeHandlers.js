import { json, methodNotAllowed, ok } from "./api.js";
...
const withPublicFallback = (handler, fallbackFactory) => async ({ req, res, match }) => {
  try {
    return await handler({ req, res, match });
  } catch (error) {
    console.error("PUBLIC ROUTE FALLBACK:", error);
    return ok(res, fallbackFactory(error));
  }
};
...
const routes = [
  ...
  },
  {
    ...
    execute: async ({ req, res }) =>
      req.method === "GET"
        ? withPublicFallback(
            ({ req: nextReq, res: nextRes }) => runController({ req: nextReq, res: nextRes, controller: getProjects }),
            () => []
          )({ req, res })
  ...
  },
  {
    ...
    execute: async ({ req, res }) =>
      req.method === "GET"
        ? withPublicFallback(
            ({ req: nextReq, res: nextRes }) => runController({ req: nextReq, res: nextRes, controller: getSkills }),
            () => []
          )({ req, res })
  ...
  },
  {
    ...
    execute: async ({ req, res }) =>
      req.method === "GET"
        ? withPublicFallback(
            ({ req: nextReq, res: nextRes }) =>
              runController({ req: nextReq, res: nextRes, controller: getSiteContent }),
            (error) => ({ ...defaultSiteContent, error: error.message })
          )({ req, res })
  ...
  },
  {
    ...
    execute: async ({ req, res }) =>
      req.method === "GET"
        ? withPublicFallback(
            ({ req: nextReq, res: nextRes }) => runController({ req: nextReq, res: nextRes, controller: getTheme }),
            (error) => ({ ...defaultTheme, error: error.message })
          )({ req, res })
  ...
  },
  {
    ...
    execute: withPublicFallback(
      ({ req, res }) => runController({ req, res, controller: getProfileAggregate }),
      (error) => ({
        githubProfile: null,
        ...
        hackerRankWarning: error.message
      })
    )
  },
  {
    ...
    execute: withPublicFallback(
      ({ req, res }) => runController({ req, res, controller: getHackerRankProfile }),
      (error) => ({
        profileUrl: "",
        certificates: [],
  ...
  },
  {
    ...
    execute: async ({ req, res }) =>
      req.method === "GET"
        ? withPublicFallback(
            ({ req: nextReq, res: nextRes }) =>
              runController({ req: nextReq, res: nextRes, controller: getCertificates }),
            () => []
          )({ req, res })
